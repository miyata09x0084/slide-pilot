...
- **結論スライド（NEW）**: タイトル直後、目次の前に1枚追加
  - 見出し: # 🎯 結論
  - 専門的な内容を中学生でも直感的に理解できる**1文のみ**で表現
  - 比喩・具体例を使って「ああ、そういうことか！」と腹落ちさせる
  - 30-50文字程度
  - 箇条書き・要点は含めない
  - 中央配置・大きな文字で視覚的に目立たせる（例: `<div class="text-center text-2xl font-bold mt-20">...</div>`）
  - 例: 「AIは大量の例題を解いてパターンを覚える優秀な生徒のようなもの」
